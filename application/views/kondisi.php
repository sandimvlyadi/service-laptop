            ...
            <div class="box-body">
              <form id="formData">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="nama_kondisi" class="form-control" placeholder="Nama Kondisi" required></input>
                </div>
                <div class="form-group">
...
<script src="<?php echo base_url('assets/admina/js/admina.kondisi.js'); ?>"></script>
</body>
</html>
