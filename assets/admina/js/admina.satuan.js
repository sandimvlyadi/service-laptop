...
$('.li-master-satuan').addClass('active');
...
$(document).ready(function(){
	...
	table = $('#dataTable').DataTable({
        ...
        'ajax' : {
        	'url'	: baseurl + 'master-satuan/datatable/',
            'type'	: 'GET',
            'dataSrc' : function(response){
            	...
            	if (response.result) {
            		for(var x in response.data){
	            		...
	            		row.push({
	            			'no'            : i,
                            'kode_satuan'   : response.data[x].kode_satuan,
...
$('#dataTable').on('click', 'button[name="btn_edit"]', function(){
    ...
    $.ajax({
        type: 'GET',
        url: baseurl + 'master-satuan/edit/'+ id +'/',
        dataType: 'json',
        success: function(response){
            if(response.result){
                var d = response.data;

                $('input[name="kode_satuan"]').val(d.kode_satuan);
                $('input[name="nama_satuan"]').val(d.nama_satuan);
...
$('#dataTable').on('click', 'button[name="btn_delete"]', function(){
	...
	$.ajax({
        type: 'POST',
        url: baseurl + 'master-satuan/delete/',
        data: {
        	'id': id,
...
$('button[name="btn_save"]').click(function(){
    ...
    $.ajax({
        type: 'POST',
        url: baseurl + 'master-satuan/save/',
        data: {
        	'id': $(this).attr('id'),
