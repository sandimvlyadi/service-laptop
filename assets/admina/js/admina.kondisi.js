...
$('.li-master-kondisi').addClass('active');
...
$(document).ready(function(){
	...
	table = $('#dataTable').DataTable({
        ...
        'ajax' : {
        	'url'	: baseurl + 'master-kondisi/datatable/',
            'type'	: 'GET',
            'dataSrc' : function(response){
            	...
            	if (response.result) {
            		for(var x in response.data){
	            		...
	            		row.push({
	            			'no'            : i,
                            'nama_kondisi'  : response.data[x].nama_kondisi,
...
$('#dataTable').on('click', 'button[name="btn_edit"]', function(){
    ...
    $.ajax({
        type: 'GET',
        url: baseurl + 'master-kondisi/edit/'+ id +'/',
        dataType: 'json',
        success: function(response){
            if(response.result){
                var d = response.data;

                $('input[name="nama_kondisi"]').val(d.nama_kondisi);
...
$('#dataTable').on('click', 'button[name="btn_delete"]', function(){
	...
	$.ajax({
        type: 'POST',
        url: baseurl + 'master-kondisi/delete/',
        data: {
        	'id': id,
...
$('button[name="btn_save"]').click(function(){
    ...
    $.ajax({
        type: 'POST',
        url: baseurl + 'master-kondisi/save/',
        data: {
        	'id': $(this).attr('id'),
