...
$('.li-master-spare-part').addClass('active');
...
$(document).ready(function(){
	...
	table = $('#dataTable').DataTable({
        ...
        'ajax' : {
        	'url'	: baseurl + 'master-spare-part/datatable/',
            'type'	: 'GET',
...
$('button[name="btn_add"]').click(function(){
    ...
    $('input[name="nama_spare_part"]').val('');
...
$('#dataTable').on('click', 'button[name="btn_edit"]', function(){
    ...
    $.ajax({
        type: 'GET',
        url: baseurl + 'master-spare-part/edit/'+ id +'/',
        dataType: 'json',
        success: function(response){
            if(response.result){
                var d = response.data;

                $('input[name="nama_spare_part"]').val(d.nama_spare_part);
...
$('#dataTable').on('click', 'button[name="btn_delete"]', function(){
	...
	$.ajax({
        type: 'POST',
        url: baseurl + 'master-spare-part/delete/',
        data: {
        	'id': id,
...
$('button[name="btn_save"]').click(function(){
    ...
    $.ajax({
        type: 'POST',
        url: baseurl + 'master-spare-part/save/',
        data: {
        	'id': $(this).attr('id'),
